**TEA Party** is a demo [ Web3.0](What_makes_a_Web3_application.md) application running on the TEA Project. 
...
# TApp is designed for [Web 3](What_makes_a_Web3_application.md)

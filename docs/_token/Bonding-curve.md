A bonding curve is a mathematical concept used to describe the relationship between price and the supply of an asset. TApp creator uses bonding curve to issue TApp tokens. 
